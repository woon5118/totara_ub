...
$string['tile_gallery_background_help'] = 'If multiple images are selected, the image will switch between the available images at random, at an interval specified by the Interval setting. The images displayed will be square so it is recommended that you upload a square image. Some approximate sizes: small 150x150, medium 200x200, large 350x350. Accepted image types are .jpg, .png, .gif and .svg.';
