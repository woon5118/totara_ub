...
$string['clialreadyconfigured'] = 'Arquivo config.php já existe. Por favor, use admin/cli/install_database.php para instalar o Totara neste site.';
$string['clialreadyinstalled'] = 'Arquivo config.php já existe. Por favor use admin/cli/install_database.php para atualizar o Totara neste site.';
...
$string['pathssubwwwroot'] = '<p>O endereço completo em que Totara pode ser acessado ou seja, o endereço que os usuários vão digitar na barra de endereços do seu navegador para acessar Totara. </p>
<p>Não é possível acessar Totara usando múltiplos endereços. Se o seu site é acessível através de múltiplos endereços, em seguida, escolher o mais fácil e configurar um redirecionamento permanente para cada um dos outros endereços. </p>
...
$string['phpversionhelp'] = '<p>O Totara requer uma versão PHP de pelo menos 5.6.5 (o 7.x tem algumas limitações do motor). </p>
