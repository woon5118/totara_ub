...
<p>Toto môže neskôr spôsobiť problémy v Totara, najmä ak máte veľa modulov a/alebo veľa používateľov.</p>
...
<ol>
<li>Ak je to možné, znovu vytvorte PHP s <i>--enable-memory-limit</i>. Toto umožní Totara samonastavenie limitu pamäte.</li>
...
$string['pathssubdataroot'] = 'Potrebujete adresár, kam Totara bude ukladať nahrané súbory. Adresár by mal povoliť čítanie a zapisovanie údajov používateľom web serveru, ale nesmie byť prístupný priamo cez web rozhranie. Pokiaľ ešte neexistuje, inštalácia sa pokúsi o jeho vytvorenie. ';
$string['pathssubdirroot'] = 'Plná cesta adresára Totara inštalácie';
...
$string['phpversionhelp'] = '<p>Totara si vyžaduje verziu PHP aspoň  4.3.0 alebo 5.1.0 (5.0.x obsahuje veľa známych chýb).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> obsahuje aplikáciu k vytvoreniu prostredia, v ktorom bude prevádzkovaný váš <strong>Totara</strong>. Menovite sa jedná o:';
