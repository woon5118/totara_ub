...
<li>En algunos servidores PHP usted puede crear en el directorio Totara un archivo .htaccess que contenga esta línea:
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de Totara. Usted puede solucionar este problema, renombrando el directorio admin en su instalación Totara, poniendo un nuevo nombre aquí. Por ejemplo: <em> moodleadmin </em>. Esto solucionará los enlaces de administración en instalación Totara.';
$string['pathssubdataroot'] = 'Usted necesita un espacio donde Totara puede guardar los archivos subidos. En este directorio debe poder LEER y ESCRIBIR el usuario del servidor web (por lo general \'nobody\',  \'apache\' o \'www-data\'), pero no debe poderse acceder a esta carpeta directamente a través de la web. El instalador tratará de crearla si no existe.';
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  Totara.</p>';
$string['pathssubwwwroot'] = 'Dirección web completa para acceder a Totara. No es posible acceder a Totara utilizando múltiples direcciones. Si su sitio tiene varias direcciones públicas debe configurar redirecciones permanentes en todas ellas, excepto en ésta. Si su sitio web es accesible tanto desde una intranet como desde Internet, escriba aquí la dirección pública y configure su DNS para que los usuarios de su intranet puedan también utilizar la dirección pública.';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar
    y ajustar <strong>Totara</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o,
