...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para instalar Totara en este sitio.';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar el Totara en este sitio.';
$string['cliinstallheader'] = 'Programa de instalación Totara de línea de comando {$a}';
...
$string['dirroot'] = 'Directorio de Totara';
...
<p>Esto puede ocasionar que Totara tenga problemas de memoria más adelante, especialmente si usted tiene activados muchos módulos y/o muchos usuarios.</p>
...
Esto hace que Totara fije por sí mismo el límite de memoria.</li>
...
<li>En algunos servidores PHP puede crear en el directorio Totara un archivo .htaccess que contenga esta línea:
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de Totara. Usted puede solucionar este problema, renombrando el directorio admin en su instalación Totara, poniendo un nuevo nombre aquí. Por ejemplo: <em> totaraadmin </em>. Esto solucionará los enlaces de administración en instalación Totara.';
$string['pathssubdataroot'] = '<p>Un directorio en el que Totara puede guardar los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  Totara.</p>';
$string['pathssubwwwroot'] = '<p>Dirección web completa para acceder a Totara, es decir, la dirección que los usuarios escribirán en la barra de búsqueda del navegador para acceder a Totara.</p>
<p>No es posible acceder a Totara utilizando múltiples direcciones. Si su portal tiene varias direcciones debe configurar la más sencilla y configurar un redireccionamiento permanente desde las otras.</p>
...
$string['phpversionhelp'] = '<p>Totara requiere al menos una versión de PHP 4.3.0 o 5.1.0 ((5.0.x tiene una serie de problemas conocidos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicaciones necesarias para que <strong>Totara</strong> funcione en su ordenador,
    principalmente:';
$string['welcomep40'] = 'El paquete también incluye <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>Totara</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
$string['welcomep70'] = 'Pulse en el botón "Siguiente" para continuar con la configuración de <strong>Totara</strong>.';
