...
<li>いくつかのPHPサーバでは、下記の行を含む.htaccessファイルをTotaraディレクトリに作成することができます:
...
$string['pathssubdataroot'] = '<p>ユーザによってアップロードされたファイルコンテンツすべてをTotaraが保存するディレクトリです。</p>
...
$string['pathssubdirroot'] = '<p>Totaraコードを含むディレクトリに関するフルパスです。</p>';
$string['pathssubwwwroot'] = '<p>Totaraにアクセスすることのできるフルウェブアドレスです。例えば、ユーザがブラウザのアドレスバーに入力してTotaraにアクセスするためのアドレスです。</p>

<p>複数アドレスを使用してTotaraにアクセスすることはできません。あなたのサイトに複数アドレスからアクセスできる場合、最も簡単なアドレスを選択して、すべてのアドレスにパーマネントリダイレクトを設定してください。</p>
...
$string['phpversionhelp'] = '<p>Totaraには少なくとも4.3.0または5.1.0のPHPバージョンが必要です (5.0.x には既知の多数の問題があります)。</p>
