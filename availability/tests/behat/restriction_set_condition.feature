...
Feature: Restriction set of course's restriction is appearing when user editing it
  ...
  Scenario: User is adding the restriction to assignment and going to remove audience, position and organisation afterward
    ...
    And I follow "Add an activity or resource"
    When I click on "Assignment" "radio" in the "Add an activity or resource" "dialogue"
    And I click on "Add" "button" in the "Add an activity or resource" "dialogue"
    ...
    Then I should not see "You are assigned to"
    And I should not see "You are a member of"
    But I should see "The activity Tuhinga 1 is marked complete"

    And I click on ".toggle-display" "css_element" in the "Tuhinga 2" activity
    And I click on "Edit settings" "link" in the "Tuhinga 2" activity
    And I expand all fieldsets
    And I should not see "Member of Audience" in the "#fitem_id_availabilityconditionsjson" "css_element"
    And I should not see "Assigned to Position" in the "#fitem_id_availabilityconditionsjson" "css_element"
    And I should not see "Assigned to Organisation" in the "#fitem_id_availabilityconditionsjson" "css_element"
    But I should see "Activity completion" in the "#fitem_id_availabilityconditionsjson" "css_element"
