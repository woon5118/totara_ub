...
class TestDataLoader(unittest.TestCase):
    ...
    def test_get_users(self):
        ...
        a list object and length of the list is as expected.
        """
        users_data = self.data_loader._DataLoader__get_users(users_data=self.users_data)
    ...
    def test_transform_data(self):
        ...
        for query in ["hybrid", "partial", "mf"]:
            ...
            self.assertEqual(
                len(transformed_data["user_ids"]), self.users_data.shape[0]
            )
