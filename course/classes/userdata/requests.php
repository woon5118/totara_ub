...
namespace core_course\userdata;
...
class requests extends item {
    ...
    public static function get_fullname_string() {
        return ['userdataitem-course-request', 'core'];
    }
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        $sql = "DELETE FROM {course_request}
    ...
    protected static function export(target_user $user, \context $context) {
        ...
        $export = new export();
        $export->data = $DB->get_records('course_request', ['requester' => $user->id], "id",
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        return $DB->count_records('course_request', ['requester' => $user->id]);
    }
}