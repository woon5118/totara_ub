...
/**
 * A hook to redirect from page '/course/management.php?categoryid=someid' where the category's id is
 * the id of category that you are not desire to display it in the page.
 */
final class course_category_management_view extends base {
    /**
     * @var int
     */
    private $category_id;
