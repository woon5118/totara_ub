...
Feature: Test unrestricted user columns can be added and viewed by the admin
  ...
  Background:
    ...
    And the following position assignments exist:
      ...
      | user2  | P1       | primary   | user1    |
      | user3  | P1       | primary   | user1    |
      | user5  | P1       | primary   | user4    |
      | user6  | P1       | primary   | user4    |
  ...
  Scenario: Test that I can add and view unrestricted user columns in report builder with email visible
    ...
    And I should see "user1@example.invalid" in the "user_manageremail" report column for "User Two"
    And I should see "user1@example.invalid" in the "user_manageremailunobscured" report column for "User Two"
    ...
    And I should see "user1@example.invalid" in the "user_manageremail" report column for "User Three"
    And I should see "user1@example.invalid" in the "user_manageremailunobscured" report column for "User Three"
    # Check User Five row
    ...
    And I should see "Email is private" in the "user_manageremail" report column for "User Five"
    And I should see "user4@example.invalid" in the "user_manageremailunobscured" report column for "User Five"
    And I log out
    ...
    And I should see "user1@example.invalid" in the "user_manageremail" report column for "User Two"
    And I should not see "user1@example.invalid" in the "user_manageremailunobscured" report column for "User Two"
    # Check User Three row
    And I should see "Email is private" in the "user_email" report column for "User Three"
    And I should not see "user3@example.invalid" in the "user_emailunobscured" report column for "User Three"
    And I should see "user1@example.invalid" in the "user_manageremail" report column for "User Three"
    And I should not see "user1@example.invalid" in the "user_manageremailunobscured" report column for "User Three"
    # Check User Five row
    And I should see "Email is private" in the "user_email" report column for "User Five"
    And I should not see "user5@example.invalid" in the "user_emailunobscured" report column for "User Five"
    And I should see "Email is private" in the "user_manageremail" report column for "User Five"
    And I should not see "user4@example.invalid" in the "user_manageremailunobscured" report column for "User Five"
