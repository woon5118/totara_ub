...
Feature: Per user visibility of user report source custom field values
  ...
  Scenario: rb_source_user_customfield001: view report with custom field per user visibility as various users
    ...
    Then I should see "<hidden>" in the "user_custom_field_1" report column for "The Chief"
    Then I should see "<hidden>" in the "user_custom_field_2" report column for "The Chief"
    Then I should see "<hidden>" in the "user_custom_field_3" report column for "The Chief"
    Then I should see "<hidden>" in the "user_custom_field_4" report column for "The Chief"
    Then I should see "<hidden>" in the "user_custom_field_5" report column for "The Chief"
    Then I should see "<hidden>" in the "user_custom_field_6" report column for "The Chief"
