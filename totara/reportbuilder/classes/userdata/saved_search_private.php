...
/**
 * This item takes care of purging and exporting all private saved searches made by the user
 */
final class saved_search_private extends item {
    ...
    protected static function export(target_user $user, \context $context) {
        ...
        $savedsql = "
            ...
            WHERE rbs.userid = :userid AND rbs.ispublic = 0
        ";
    ...
    protected static function count(target_user $user, \context $context) {
        global $DB;
        return $DB->count_records('report_builder_saved', ['userid' => $user->id, 'ispublic' => 0]);
    }
}