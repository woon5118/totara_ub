...
$string['userdataitemglobal_report_restrictions'] = 'Global report restictions';
$string['userdataitemglobal_report_restrictions_help'] = 'Purge will remove users asignments from appearing in restricted reports and accessing restricted reports.';
$string['userdataitemsaved_search_private'] = 'Private saved searches';
$string['userdataitemsaved_search_private_help'] = 'Purge will also remove scheduled reports that based on relevant saved searches.';
$string['userdataitemsaved_search_public'] = 'Public saved searches';
$string['userdataitemsaved_search_public_help'] = 'Purge will also remove scheduled reports that based on relevant saved searches.';
