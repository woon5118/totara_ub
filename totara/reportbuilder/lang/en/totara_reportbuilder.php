...
$string['contentdesc_userprimarydirect'] = 'The {$a->field} reports directly to "{$a->user}" in their primary job assignment';
$string['contentdesc_userprimaryindirect'] = 'The {$a->field} reports indirectly to "{$a->user}" in their primary job assignment';
$string['contentdesc_userprimarytemp'] = 'The {$a->field} temporarly reports to "{$a->user}" in their primary job assignment';
$string['contentdesc_useralldirect'] = 'The {$a->field} reports directly to "{$a->user}" in one of their job assignments';
$string['contentdesc_userallindirect'] = 'The {$a->field} reports indirectly to "{$a->user}" in one of their job assignments';
$string['contentdesc_useralltemp'] = 'The {$a->field} temporarly reports to "{$a->user}" in one of their job assignments';
$string['contentdesc_posprimarybelow'] = 'The user\'s current position is below "{$a}" in their primary job assignment';
$string['contentdesc_posprimaryboth'] = 'The user\'s current position is equal to or below "{$a}" in their primary job assignment';
$string['contentdesc_posprimaryequal'] = 'The user\'s current position is equal to "{$a}" in their primary job assignment';
$string['contentdesc_posallbelow'] = 'The user\'s current position is below "{$a}" in one of their job assignments';
$string['contentdesc_posallboth'] = 'The user\'s current position is equal to or below "{$a}" in one of their job assignments';
$string['contentdesc_posallequal'] = 'The user\'s current position is equal to "{$a}" in one of their job assignments';
$string['contentdesc_orgprimarybelow'] = 'The user\'s current organisation is below "{$a}" in their primary job assignment';
$string['contentdesc_orgprimaryboth'] = 'The user\'s current organisation is equal to or below "{$a}" in their primary job assignment';
$string['contentdesc_orgprimaryequal'] = 'The user\'s current organisation is equal to "{$a}" in their primary job assignment';
$string['contentdesc_orgallbelow'] = 'The user\'s current organisation is below "{$a}" in one of their job assignments';
$string['contentdesc_orgallboth'] = 'The user\'s current organisation is equal to or below "{$a}" in one of their job assignments';
$string['contentdesc_orgallequal'] = 'The user\'s current organisation is equal to "{$a}" in one of their job assignments';
...
$string['jobassign_appraiser'] = 'All Assigned Appraiser(s)';
$string['jobassign_children'] = 'Include children';
$string['jobassign_filter'] = 'Job assignment filter(s)';
$string['jobassign_filter_help'] = 'TODO - write an explaination of the filter

    Contains = "Any"
    Not contains = "Not Any"
    Equals = "And"
    There isn\'t a Not equals... yet

    NOTE: This filters against the live database even if the report is cached.';
$string['jobassign_jobtitle'] = 'All Assigned Job(s)';
...
$string['showrecordsbeloworgonly'] = 'Just staff below the user\'s <strong>primary</strong> organisation';
$string['showrecordsbeloworgonlyall'] = 'Just staff below <strong>any</strong> of the user\'s organisations';
$string['showrecordsbelowposonly'] = 'Just staff below the user\'s <strong>primary</strong> position';
$string['showrecordsbelowposonlyall'] = 'Just staff below the <strong>any</strong> of the user\'s positions';
$string['showrecordsinorg'] = 'Just staff in the user\'s <strong>primary</strong> organisation';
$string['showrecordsinorgall'] = 'Just staff in <strong>any</strong> of the user\'s organisations';
$string['showrecordsinorgandbelow'] = 'Staff at or below the user\'s <strong>primary</strong> organisation';
$string['showrecordsinorgandbelowall'] = 'Staff at or below <strong>any</strong> of the user\'s organisations';
$string['showrecordsinpos'] = 'Just staff in the user\'s <strong>primary</strong> position';
$string['showrecordsinposall'] = 'Just staff in <strong>any</strong> of the user\'s positions';
$string['showrecordsinposandbelow'] = 'Staff at or below the user\'s <strong>primary</strong> position';
$string['showrecordsinposandbelowall'] = 'Staff at or below <strong>any</strong> of the user\'s positions';
...
$string['type_primary_job'] = 'User\'s Primary Job Assignment';
...
$string['userdirectreports'] = 'Records for user\'s direct reports in their <strong>primary</strong> job assignment';
$string['userdirectreportsall'] = 'Records for user\'s direct reports for <strong>any</strong> of the user\'s job assignments';
...
$string['userindirectreports'] = 'Records for user\'s indirect reports in their <strong>primary</strong> job assignment';
$string['userindirectreportsall'] = 'Records for user\'s indirect reports for <strong>any</strong> of the user\'s job assignments';
...
$string['usersmanageremailall'] = 'User\'s Manager Email(s)';
...
$string['usertempreports'] = 'Records for user\'s temporary reports for the user\'s <strong>primary</strong> job assignment';
$string['usertempreportsall'] = 'Records for user\'s temporary reports for <strong>any</strong> of the user\'s job assignments';
