...
Feature: A basic test of the Totara custom menu
  ...
  Background:
    ...
    And I click on "Add new menu item" "button"
    And I should see "Test item" in the "#totaramenu" "css_element"
  ...
  Scenario: Move menu items
    ...
    And I set the following fields to these values:
      ...
      | Menu default url address | /my/        |
    And I click on "Add new menu item" "button"
    And I should see "Test item 2" in the "#totaramenu" "css_element"
  ...
  Scenario: Delete menu items
    ...
    And I click on "My Learning" "link" in the "#totaramenu" "css_element"
    Then I should not see "Test item" in the "#totaramenu" "css_element"
