...
define(['core/templates'], function(templates) {
    ...
    function PagingManager() {
        ...
        this.eventNode = '';
        this.page = 1;
        this.template = 'totara_core/paging_content';
        this.widget = '';
    }
    ...
    PagingManager.prototype.bubbledEventsListener = function() {
        var that = this;
        this.eventNode.addEventListener(this.eventListener + ':changed', function(e) {
    ...
    PagingManager.prototype.onChange = function() { /* Null */ };
    PagingManager.prototype.onChangeAppendType = function() { /* Null */ };
