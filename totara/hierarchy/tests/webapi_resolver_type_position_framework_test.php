 ...
 */
class totara_hierarchy_webapi_resolver_type_position_framework_testcase extends advanced_testcase {

    private function resolve($field, $pos, array $args = []) {
        return \totara_hierarchy\webapi\resolver\type\position_framework::resolve(
            $field,
            (object)$pos,
            $args,
