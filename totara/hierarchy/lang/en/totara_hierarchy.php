...
$string['bulktypechanges'] = 'Bulk reclassify goal types';
$string['bulktypechangesdesc'] = 'This feature enables you to reassign all goals with the selected type (below) to another type. If custom fields are defined for the selected type and it\'s possible to map the data into custom fields of the target type, you will be presented with options to do this.';
