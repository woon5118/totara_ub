...
class assignment_user_created extends \hierarchy_goal\event\assignment_created {
    ...
    /**
     * The type of assignment for use in name/descriptions.
     */
    ...
    protected function get_legacy_url() {
        return new \moodle_url('/totara/hierarchy/prefix/goal/mygoals.php', array('userid' => $this->data['other']['instanceid']));
    }
}
