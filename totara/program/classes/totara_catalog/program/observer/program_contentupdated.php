...
class program_contentupdated extends object_update_observer {

    public function get_observer_events(): array {
        return [
            '\totara_program\event\program_contentupdated',
        ];
    }

    /**
     * init program update object based on update program content
     */
