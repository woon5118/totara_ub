...
class manager_program_completion extends base {

    public function __construct() {
        parent::__construct();

        $this->fullname        = get_string('template:manager_program_completion:title', 'rb_source_program_completion');
        $this->shortname       = 'manager_program_completion';
        $this->summary         = get_string('template:manager_program_completion:summary', 'rb_source_program_completion');
        $this->source          = 'program_completion';
        $this->label           = get_string('template:manager_program_completion:label', 'rb_source_program_completion');
    ...
    protected function define_columns() : array {
        $columns = array(
            array(
                'type' => 'progcompletion',
                'value' => 'status',
                'heading' => get_string('template:manager_program_completion:status', 'rb_source_program_completion'),
                'customheading' => 1,
            ),
            array(
                'type' => 'prog',
                'value' => 'id',
                'heading' => get_string('template:manager_program_completion:numberofprograms', 'rb_source_program_completion'),
                'customheading' => 1,
