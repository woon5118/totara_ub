...
class enrolled_program_item_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventprogramitemadded', 'totara_cohort');
    }
    ...
    public function get_description() {
        return "The program {$this->other['instanceid']} has been added to the cohort {$this->other['cohortid']}";
    }
    ...
    public function get_url() {
        return new \moodle_url('/totara/cohort/enrolledlearning.php', array('id' => $this->other['cohortid']));
    }
