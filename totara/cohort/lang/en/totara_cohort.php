...
$string['userdataitemdynamic_membership_help'] = 'Purging will remove the user from any dynamic audiences; however, after purging is complete, they may be added back again if they still meet the criteria. In this instance, data that was deleted due to their removal from the audience, such as enrolment dates, may not be restored even though their audience membership is.';
