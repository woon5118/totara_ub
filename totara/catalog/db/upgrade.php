...
function xmldb_totara_catalog_upgrade($oldversion) {
    ...
    if ($oldversion < 2019052300) {
        // Add legacy search option in admin settings.
        // When enabled, 'like' search will be used instead of FTS.
        set_config('cataloglegacysearch', 0);
        ...
        upgrade_plugin_savepoint(true, 2019052300, 'totara', 'catalog');
    }
