...
final class search_metadata {
    ...
    public function save(): void {
        ...
        if ($old->instanceid != $this->instanceid ||
            ...
            throw new \coding_exception(
                "Cannot update the search_metadata, because there are differences in fields: " .
                "'instanceid', 'pluginname' and 'plugintype'"
            );
        }
    ...
    public function __set(string $name, $value): void {
        if (!property_exists($this, $name)) {
            throw new \coding_exception(
                "The class search_metadata does not accept to create any new property on a fly"
            );
        }
