...
$string['no_rateable_competencies'] = 'No rateable competencies.';
$string['no_rating_given'] = 'No rating given';
$string['number_of_competencies'] = '{$a} competencies';
...
$string['submit_ratings_confirmation_header'] = 'Submit ratings and comments';
$string['submit_ratings_confirmation_question'] = 'Do you want to submit these ratings?';
$string['submit_ratings_summary_plural_other'] = 'You\'ve rated {$a->subject_user} for {$a->amount} competencies.';
$string['submit_ratings_summary_plural_self'] = 'You\'ve rated yourself for {$a->amount} competencies.';
$string['submit_ratings_summary_singular_other'] = 'You\'ve rated {$a->subject_user} for 1 competency.';
$string['submit_ratings_summary_singular_self'] = 'You\'ve rated yourself for 1 competency.';
