...
$string['achievementpath_group_label_single'] = 'Criteria fulfilment';
...
$string['action:archive_this'] = 'Archive this assignment';
...
$string['action:archive_user_assignment:modal'] = 'This assignment and associated achievement record will be archived. If there are no other active assignments remaining after this one is archived, it means that progress against the achievement criteria for this competency will no longer be tracked.';
...
$string['chart_label:proficient'] = 'proficient';
...
$string['error:archive_user_assignment'] = "You do not have the capability to archive this assignment.";
...
$string['header:archived_date'] = 'Archived date';
