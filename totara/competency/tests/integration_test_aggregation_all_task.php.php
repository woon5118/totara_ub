...
//        }
    ...
    /**
     * Test competency aggregate_all task with a combination of criteria_groups and multiple runs
     */
    public function test_aggregation_all_task_criteria_groups_multiple_criteria_multiple_runs() {
        $data = $this->setup_data();

        // Splitting the function for readability
        $this->setup_criteria_groups_multiple_criteria_multiple_runs_data($data);
        $this->criteria_groups_multiple_criteria_multiple_run_1($data);
        $this->criteria_groups_multiple_criteria_multiple_run_2($data);
        $this->criteria_groups_multiple_criteria_multiple_run_3($data);
    }
     ...
     * @param \stdClass $data
     */
    private function criteria_groups_multiple_criteria_multiple_run_1($data) {
     ...
     * @param \stdClass $data
     */
    private function criteria_groups_multiple_criteria_multiple_run_2($data) {
     ...
     * @param \stdClass $data
     */
    private function criteria_groups_multiple_criteria_multiple_run_3($data) {
