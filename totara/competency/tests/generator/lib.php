...
class totara_competency_generator extends component_generator_base {
     ...
     */
    public function create_course_completion($course, $user, int $completion_status) {
        global $CFG;
     ...
     */
    public function create_learning_plan($for_user, $competencies, bool $completed = false): development_plan {
        global $CFG;
