...
function xmldb_criteria_linkedcourses_upgrade($oldversion) {
    ...
    if ($oldversion < 2019100200) {
        ...
        $params = [
            'metadatakey' => \criteria_linkedcourses\linkedcourses::METADATA_COMPETENCY_KEY,
            'pathtype' => 'criteria_group',
            'criteriatype' => 'onactivate',
            'metadatakey2' => \criteria_linkedcourses\linkedcourses::METADATA_COMPETENCY_KEY,
        ];

        $DB->execute($sql, $params);

        // Assign savepoint reached.
        upgrade_plugin_savepoint(true, 2019100200, 'criteria', 'linkedcourses');
    }
