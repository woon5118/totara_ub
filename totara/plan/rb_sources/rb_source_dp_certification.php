...
class rb_source_dp_certification extends rb_base_source {
    ...
    protected function define_joinlist() {
        ...
        $this->add_all_job_assignments_tables_to_joinlist($joinlist, 'certif_completion', 'userid');
        $this->add_primary_job_assignment_tables_to_joinlist($joinlist, 'certif_completion', 'userid');
