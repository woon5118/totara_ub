...
class evidence_created extends \core\event\base {
    ...
    public static function create_from_instance($instance) {
        debugging('\totara_plan\event\evidence_created has been deprecated and is no longer used, please use totara_evidence\event\evidence_item_created instead.', DEBUG_DEVELOPER);
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventevidencecreated', 'totara_plan');
    }
