...
class plan_evidence_action_links extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        debugging('\totara_plan\rb\display\plan_evidence_action_links has been deprecated and is no longer used, please use totara_evidence\rb\display\evidence_item_actions instead.', DEBUG_DEVELOPER);
        global $USER, $OUTPUT;
