...
/**
 * Wizard test form for testing features that deviate from the default settings.
 * Use group_wizard_default to test default settings.
 *
 * @author    Matthias Bonk <matthias.bonk@totaralearning.com>
 ...
 * @package   totara_form
 */
class group_wizard_features extends group_wizard {
    ...
    public static function get_form_test_name() {
        return 'Basic wizard group features';
    }
    ...
    public static function get_form_controller() {
        return new group_wizard_features_controller();
    }
}