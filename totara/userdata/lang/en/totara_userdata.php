...
$string['purgemanualschedule_desc'] = 'Schedule an ad hoc task to immediately delete user data. The specific data deleted will be determined by the purge type you select.';
