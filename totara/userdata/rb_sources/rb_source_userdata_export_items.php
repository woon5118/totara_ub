...
class rb_source_userdata_export_items extends rb_base_source {
    ...
    public function __construct() {
        ...
        $this->add_export(new rb_join('export', 'INNER', '{totara_userdata_export}', 'export.id = base.exportid'));
        $this->add_export_type(new rb_join('export_type', 'INNER', '{totara_userdata_export_type}', 'export.exporttypeid = export_type.id', null, 'export'));
    ...
    protected function define_filteroptions() {
        ...
        $filteroptions[] = new rb_filter_option(
            ...
            'multicheck',
            array(
                'selectfunc' => 'export_item_results',
                'simplemode' => true,
            )
        );
    ...
    protected function define_defaultcolumns() {
        return array(
            ...
            array('type' => 'export_item', 'value' => 'name'),
            array('type' => 'export_item', 'value' => 'component'),
            array('type' => 'export_item', 'value' => 'timefinished'),
            array('type' => 'export_item', 'value' => 'result'),
        );
    }

    protected function define_paramoptions() {
        $paramoptions = array(
            new rb_param_option('exportid', 'base.exportid'),
            new rb_param_option('userid', 'export.userid', array('export')),
        );

        return $paramoptions;
    }

    public function rb_filter_export_item_results() {
