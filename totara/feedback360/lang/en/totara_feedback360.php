...
$string['userdataitemresp_assignments'] = 'Responses to Feedback360 requests';
$string['userdataitemresp_assignments_help'] = 'The user\'s response to any Feedback360 requests they have received. Note that self evaluation will be included in both Feedback360 user data items';
$string['userdataitemuser_assignments'] = 'Assignments including all responses';
$string['userdataitemuser_assignments_help'] = 'Any Feedback360 the user has been assigned to, and any responses users have made to their requests. Note that self evaluation will be included in both Feedback360 user data items';
