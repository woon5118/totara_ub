...
$returnurl = new moodle_url('/admin/user_legacy.php', array('sort' => $sort, 'dir' => $dir, 'perpage' => $perpage, 'page'=>$page));
...
foreach ($columns as $column) {
    ...
    $$column = "<a href=\"userold.php?sort=$column&amp;dir=$columndir\">".$string[$column]."</a>$columnicon";
}
...
$baseurl = new moodle_url('/admin/user_legacy.php', array('sort' => $sort, 'dir' => $dir, 'perpage' => $perpage));
