 ...
 */
namespace logstore_legacy\userdata;
...
/**
 * This item is responsible for purging, exporting and counting legacy log records.
 */
class legacy_log extends item {
    ...
    protected static function export(target_user $user, \context $context) {
        global $DB;
        $export = new export();
        $export->data = $DB->get_records('log', ['userid' => $user->id]);
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        return $DB->count_records('log', ['userid' => $user->id]);
    }
}
