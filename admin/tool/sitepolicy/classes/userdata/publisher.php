...
/**
 * This item takes care of purging publisher of user policy version
 */
final class publisher extends item {
    /**
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        $DB->set_field('tool_sitepolicy_policy_version', 'publisherid', NULL, ['publisherid' => $user->id]);
