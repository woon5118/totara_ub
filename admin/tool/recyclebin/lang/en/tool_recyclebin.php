...
$string['crondelaymodule'] = 'One or more activities or resources are currently being deleted. Try refreshing the page to see if they are ready.';
...
$string['deletecheckrecyclebin'] = 'It will appear in the recycle bin after cron has run.'; // TOTARA TL-16427.
