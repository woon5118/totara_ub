...
if ($hassiteconfig
 ...
 or has_capability('moodle/cohort:view', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    $ADMIN->add('accounts', new admin_externalpage('cohortglobalsettings', new lang_string('cohortglobalsettings', 'totara_cohort'), $CFG->wwwroot . '/totara/cohort/globalsettings.php', array('moodle/cohort:manage')));
