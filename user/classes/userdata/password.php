 ...
 * Passwords.
 */
class password extends \totara_userdata\userdata\item {
    /**
    ...
    public static function get_fullname_string() {
        return ['userdataitem-user-password', 'core'];
    }
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        $DB->set_field('user', 'password', '', array('id' => $user->id));
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        return $DB->count_records_select('user', "id = :id AND password <> ''", array('id' => $user->id));
    }
}