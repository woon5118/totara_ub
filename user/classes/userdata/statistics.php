...
/**
 * Class for representation of user data stored in statistics report
 *
 * The data is purgeable, exportable and countable.
 *
 */
class statistics extends item {
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        $DB->delete_records('stats_user_daily', ['userid' => $user->id]);
        $DB->delete_records('stats_user_weekly', ['userid' => $user->id]);
        $DB->delete_records('stats_user_monthly', ['userid' => $user->id]);
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        return $DB->count_records('stats_user_monthly', ['userid' => $user->id]);
    }
}