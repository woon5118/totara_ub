...
/**
 * All custom profile fields which are by default visible to the user. That includes 'visible to all' and 'restricted' fields
 * but not 'not visible' fields which need "moodle/user:viewalldetails" capability in user context
 * or "moodle/course:viewhiddenuserfields" capability in course context to view them.
 */
class customfields_uservisible extends \totara_userdata\userdata\item {
    ...
    public static function get_fullname_string() {
        return ['userdataitem-user-customfields_uservisible', 'core'];
    }
