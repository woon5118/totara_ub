 ...
 * Password history.
 */
class password_history extends \totara_userdata\userdata\item {
    /**
    ...
    public static function get_fullname_string() {
        return ['userdataitem-user-passwordhistory', 'core'];
    }
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        return $DB->count_records('user_password_history', array('userid' => $user->id));
    }
}