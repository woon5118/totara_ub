...
$string['auth_mnetdescription'] = 'Users are authenticated according to the web of trust defined in your Totara Network settings.';
...
$string['pluginname'] = 'MNet authentication (deprecated)';
