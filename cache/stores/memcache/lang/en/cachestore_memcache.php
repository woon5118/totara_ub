...
$string['sessionhandlerconflict'] = 'Warning: A memcache instance ({$a}) has been configured to use the same memcache server as sessions. Purging all caches will lead to sessions also being purged.';
