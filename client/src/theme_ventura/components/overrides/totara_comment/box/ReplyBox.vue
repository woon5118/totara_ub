...
.tui-replyBox {
  ...
  &__replyLinkBox {
    ...
    &--withSeparator {
      border-top: var(--tui-border-width-thin) solid var(--tui-color-neutral-4);
    }

    &--withoutSeparator {
      // Hide the line, but keep the position as same.
      border-top: var(--tui-border-width-thin) solid transparent;
    }
  ...
  &__reply {
    ...
    border-top: var(--tui-border-width-thin) solid var(--tui-color-neutral-5);
