...
.tui-weka {
  ...
  .ProseMirror-selectednode {
    outline: var(--tui-border-width-normal) solid var(--tui-weka-select-color);
  }
  ...
  li.ProseMirror-selectednode:after {
    ...
    bottom: -2px;
    left: -32px;
    border: var(--tui-border-width-normal) solid var(--tui-weka-select-color);
    content: '';
    pointer-events: none;
  }
