...
define([ 'core/mustache',
   ...
   /** @var {string[]} flexIconCache - Cache of already loaded flex icon maps */
    ...
    // NOTE: there is no currentThemeName property because only current config.theme is supported!!! */
    ...
    var pixHelper = function(sectionText, helper) {
        ...
        var useFlexIcons = flexIconShouldReplacePixIcon(flexIdentifier);
        ...
        var template = templateCache[config.theme + '/core/pix_icon'];
     ...
     * @return {Boolean}
     */
    var flexIconShouldReplacePixIcon = function(identifier) {

        if (isLegacyIdentifier(identifier) === false) {
            return false;
        }

        if (flexIconHasMapData(identifier) === false) {
            return false;
        }
     ...
     * @return {Boolean}
     */
    var flexIconHasMapData = function(identifier) {
    ...
    */
    ...
    var addHelpers = function(context, themeName) {
        ...
        context.currentTheme = config.theme;
    };
