...
define(['jquery', 'core/modal_events', 'core/modal', 'core/modal_save_cancel', 'core/modal_confirm', 'core/modal_cancel',
     ...
     * @param {object} context Additional context for the modal
     * @return {promise} Resolved with a Modal instance
     */
    var createFromType = function(type, triggerElement, context) {
        var templateName = TEMPLATES[type];

        var modalPromise = Templates.render(templateName, context)
            .then(function(html) {
     ...
     * @return {promise} Resolved with a Modal instance
     */
    var create = function(modalConfig, triggerElement, context) {
        ...
        return createFromType(type, triggerElement, context)
            .then(function(modal) {
