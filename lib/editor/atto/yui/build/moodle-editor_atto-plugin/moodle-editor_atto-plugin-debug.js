...
EditorPluginButtons.prototype = {
    ...
    addBasicButton: function(config) {
        ...
        config.callback = function() {
            var selection = null;
            // TL-18776 IE/Edge has an issue where the previous selection was maintained after performing some operations
            // This ensures that the current selection is used for the operation. Restoring is not required.
            if (document.body.classList.contains('ie') || document.body.classList.contains('msedge')) {
