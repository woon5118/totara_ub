...
class user implements \core\webapi\type_resolver {
    ...
    private const FIELDS_DB = [
        ...
        'icq',                      // Type: character varying(15)  , default '' (not null)
        'skype',                    // Type: character varying(50)  , default '' (not null)
        'yahoo',                    // Type: character varying(50)  , default '' (not null)
        'aim',                      // Type: character varying(50)  , default '' (not null)
        'msn',                      // Type: character varying(50)  , default '' (not null)
