...
DOCK.prototype = {
    ...
    _initialiseDockControls : function() {
        ...
        require(['core/templates'], function (templates) {
            ...
            templates.renderIcon(icon, M.util.get_string('undockall', 'block')).done(function (html) {
...
BLOCK.prototype = {
    ...
    moveToDock : function(e) {
        ...
        require(['core/templates'], function (templates) {
            ...
            templates.renderIcon(icon, Y.Escape.html(M.util.get_string('undockitem', 'block'))).done(function (html) {
                moveto.append(html);
            });
        });
