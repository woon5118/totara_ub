...
class core_formslib_testcase extends advanced_testcase {
    ...
    public function test_group_class() {
        ...
        $expected = '<div id="fgroup_id_group_1" class="fitem test fitem_fgroup femptylabel"><fieldset class="fgroup test error"><div class="felement"><span class="error" tabindex="0"></span>{element}</div></fieldset></div>';
