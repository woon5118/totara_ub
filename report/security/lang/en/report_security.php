...
$string['check_legacynocleantrusttext_details'] = '<p>We do not recommend enabling legacy noclean and trust text support</p><p>When enabled content created by trainers and other privileged users will not be consistently sanitized. HTML tags and attributes that can be used to execute security attacks will not be removed from areas such course descriptions, activity introductions and questions.</p>';
$string['check_legacynocleantrusttext_name'] = 'Legacy noclean and trust text support';
$string['check_legacynocleantrusttext_ok'] = 'Legacy support for noclean and trust text is currently disabled.';
$string['check_legacynocleantrusttext_serious'] = 'Legacy support for noclean and trust text is enabled.';
