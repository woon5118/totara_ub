...
$string['editcohortidnumber'] = 'Edit audience ID';
$string['editcohortname'] = 'Edit audience name';
...
$string['newnamefor'] = 'New name for audience {$a}';
$string['newidnumberfor'] = 'New ID number for audience {$a}';
