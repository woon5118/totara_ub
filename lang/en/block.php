...
$string['config_settings_block_title'] = 'Block title (no title if blank)';
$string['config_settings_block_hiding'] = 'Allow block hiding';
$string['config_settings_block_docking'] = 'Allow block docking';
$string['config_display_with_header'] = 'Header';
$string['config_display_with_border'] = 'Border';
