...
$string['publishgridcatalogimage'] = 'Allow public access to catalogue pictures';
$string['publishgridcatalogimage_help'] = 'If enabled, this setting provides transparent catalogue image access to external services.';
$string['query'] = 'Query';
