...
$string['configtimezone'] = 'You need to select the server timezone here. It is used as the default timezone for all users that have not set a timezone in their profile. Cron tasks and other server settings are specified in this timezone. You should change the setting if it shows as "Invalid timezone"';
