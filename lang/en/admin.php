...
$string['configguesthomepage'] = 'If you wish to use Dashboard or Find learning you must first go to Security settings and disable \'Force users to log in\'. Also for any dashboard you wish to include you must change its default settings to enable guest access.';
