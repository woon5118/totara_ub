...
$string['userdataitem-user-customfields_notvisible'] = 'Custom profile fields (not visible)';
$string['userdataitem-user-customfields_notvisible_help'] = 'All custom fields which are only viewable by users with "moodle/user:viewalldetails" capability in user context or "moodle/course:viewhiddenuserfields" capability in course context.';
$string['userdataitem-user-customfields_uservisible'] = 'Custom profile fields (visible for the user)';
$string['userdataitem-user-customfields_uservisible_help'] = 'All custom fields which are visible to the user by default. This includes custom fields visible to everyone and restricted custom fields which are only visible to the user and for users with "moodle/user:viewalldetails" capability in user context or "moodle/course:viewhiddenuserfields" capability in course context.';
...
$string['userdataitem-user-preference_help'] = 'User preferences include language, timezone, calendar and theme.';
$string['userdataitem-user-systemaccess'] = 'System access';
$string['userdataitem-user-systemaccess_help'] = 'System access includes first access timestamp, last access timestamp, last login timestamp, current login timestamp, last course access and last ip.';
$string['userdataitem-user-username'] = 'Username';
$string['userdataitem-user-username_help'] = 'Username is a required field for all active and suspended accounts. It can be randomised for deleted accounts only.';
