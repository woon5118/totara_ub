...
$string['userdataitemsubmissions_help'] = 'This includes assessment and grading by self and others. When exporting, this means user could see assessment data that is not ordinarily visible to them.';
