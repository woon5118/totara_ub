...
$string['userdataitemsubmissions_help'] = 'This will also include assessment and grading by self and other users. Assessment data may be exported in cases where it is not visible in the interface.';
