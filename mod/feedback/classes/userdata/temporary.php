...
/**
 * This item is responsible for exporting, deleting and purging learners temporary feedback module responses.
 */
class temporary extends item {
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        if ($records) {
            ...
            $DB->delete_records_select('feedback_valuetmp', ' id ' . $select, $params);
            $DB->delete_records('feedback_completedtmp', ['userid' => $user->id]);
