...
/**
 * This item is responsible for exporting, deleting and purging learners archived feedback module responses.
 */
class archived extends item {
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        if ($records) {
            ...
            $DB->delete_records_select('feedback_value_history', ' id ' . $select, $params);
            $DB->delete_records('feedback_completed_history', ['userid' => $user->id]);
