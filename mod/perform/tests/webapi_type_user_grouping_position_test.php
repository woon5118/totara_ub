 ...
 */
class mod_perform_webapi_type_user_grouping_position_testcase extends advanced_testcase {
    /**
     * @covers ::resolve
     */
    public function test_invalid_input(): void {
        [, $context] = $this->create_pos();
        $webapi_context = $this->get_webapi_context($context);

        $this->expectException(coding_exception::class);
        $this->expectExceptionMessageRegExp("/stdClass/");
        user_grouping_position::resolve('id', [], [], $webapi_context);
    }
    ...
    public function test_invalid_field(): void {
        ...
        user_grouping_position::resolve($field, $position, [], $webapi_context);
    }
    ...
    public function test_resolve(
        ...
        $value = user_grouping_position::resolve($field, $source, $args, $webapi_context);
    ...
    public function td_resolve(): array {
        [$source, $context] = $this->create_pos(
    ...
    /**
     * Generates a test position.
     *
     * @param string $description position description.
     *
     * @return array (test position, context) tuple.
     */
    private function create_pos(string $description=''): array {
        global $USER;
        $this->setAdminUser();
        ...
        $source = (object) [
            'id' => 34324,
            'shortname' => 'My test position',
            'fullname' => 'My test position long name',
            'idnumber' => 'My test position idnumber',
