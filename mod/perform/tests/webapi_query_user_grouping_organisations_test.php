...
use mod_perform\webapi\resolver\query\user_grouping_organisations;
use mod_perform\webapi\resolver\type\user_grouping_organisation;

use totara_webapi\graphql;

/**
 * @coversDefaultClass user_grouping_organisations.
 *
 * @group perform
 *
 ...
 */
class mod_perform_webapi_query_user_grouping_organisations_testcase extends advanced_testcase {
    /**
     * @covers ::resolve
     */
    public function test_find(): void {
        ...
        $actual_groups = user_grouping_organisations::resolve([], $context);
     ...
     * Generates test data.
     *
     * @param int $count no of organisations to generate.
     *
     * @return array[int=>stdClass] the mapping of organisation ids to
     *         organisations.
     */
    ...
    private function graphql_return(\stdClass $group, execution_context $context): array {
        $resolve = function (string $field) use ($group, $context) {
            return user_grouping_organisation::resolve($field, $group, [], $context);
        };
    ...
    private function get_webapi_context(): execution_context {
        return execution_context::create('ajax', 'mod_perform_user_grouping_organisations');
    }
}
