...
$string['notification_broker_overdue'] = 'Overdue reminder';
$string['notification_preview_for'] = 'Notification preview for {$a}';
$string['notification_preview_key_body'] = 'Body string key:';
$string['notification_preview_key_subject'] = 'Subject string key:';
$string['notification_preview_recipient'] = 'Recipient:';
$string['notification_preview_sample'] = 'Sample';
$string['notification_preview_type'] = 'Type:';
$string['notification_table_participants'] = 'All responding participants';
$string['notification_table_preview'] = 'Preview';
