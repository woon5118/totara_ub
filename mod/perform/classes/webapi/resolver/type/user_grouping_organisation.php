...
use mod_perform\user_groups\formatter\organisation as organisation_formatter;

defined('MOODLE_INTERNAL') || die();

/**
 * Maps a stdclass (from the database) into the GraphQL mod_perform_organisation
 * type.
 */
class user_grouping_organisation implements type_resolver {
    /**
     * Default formats.
     */
    ...
    public static function resolve(string $field, $source, array $args, execution_context $ec) {
        ...
        $formatter = new organisation_formatter($source, $context);
