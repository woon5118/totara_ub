...
class participant_section implements type_resolver {
    ...
    /**
     * @param string $field
     * @param participant_section_model $element_response
     * @param array $args
    ...
    public static function resolve(string $field, $element_response, array $args, execution_context $ec) {
        if (!$element_response instanceof participant_section_model) {
            throw new \coding_exception('Expected participant_section model');
        }

        $format = $args['format'] ?? format::FORMAT_HTML;
        $formatter = new participant_section_formatter($element_response, $ec->get_relevant_context());
