...
use mod_perform\user_groups\formatter\cohort as cohort_formatter;

defined('MOODLE_INTERNAL') || die();

/**
 * Maps a stdclass (from the database) into the GraphQL mod_perform_cohort type.
 */
class user_grouping_cohort implements type_resolver {
    /**
     * Default formats.
     */
