...
/**
 * Handles the "mod_perform_user_grouping_positions" GraphQL query.
 *
 * TODO: this should be combined with totara_competency/user_groups and put into
 * totara core somewhere.
 */
class user_grouping_positions implements query_resolver {
    /**
     * {@inheritdoc}
     */
    public static function resolve(array $args, execution_context $ec) {
        ...
        // a database.
        return position::repository()
            ->set_filters(['visible' => true])
            ->get()
            ->map_to(
                function (position $org): \stdClass {
                    return (object) $org->to_array();
                }
            );
    }
}
