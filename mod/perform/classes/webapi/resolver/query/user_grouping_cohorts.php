...
/**
 * Handles the "mod_perform_user_grouping_cohorts" GraphQL query.
 *
 * TODO: this should be combined with totara_competency/user_groups and put into
 * totara core somewhere.
 */
class user_grouping_cohorts implements query_resolver {
    /**
     * {@inheritdoc}
     */
    public static function resolve(array $args, execution_context $ec) {
        ...
        return cohort::repository()
            ...
            ->get()
            ->map_to(
                function (cohort $cohort): \stdClass {
                    return (object) $cohort->to_array();
                }
            );
    }
}
