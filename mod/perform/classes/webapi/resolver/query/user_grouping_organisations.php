...
/**
 * Handles the "mod_perform_user_grouping_organisations" GraphQL query.
 *
 * TODO: this should be combined with totara_competency/user_groups and put into
 * totara core somewhere.
 */
class user_grouping_organisations implements query_resolver {
    /**
     * {@inheritdoc}
     */
    public static function resolve(array $args, execution_context $ec) {
        ...
        return organisation::repository()
            ...
            ->get()
            ->map_to(
                function (organisation $org): \stdClass {
