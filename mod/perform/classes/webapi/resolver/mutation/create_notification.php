...
class create_notification implements mutation_resolver, has_middleware {
    ...
    public static function resolve(array $args, execution_context $ec) {
        ...
        include($CFG->dirroot . '/mod/perform/db/notifications.php');
        if (!isset($notifications[$class_key])) {
            throw new \invalid_parameter_exception('unimplemented notification class_key');
        }

        // Create notification.
        $notification = notification_model::create($activity, $class_key);

        // If successfully created, set activation.
