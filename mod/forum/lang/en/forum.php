...
$string['userdataitemposts'] = 'Forum posts and replies';
...
$string['userdataitemtracking_help'] = 'If the user activated forum tracking, all forum reads will be tracked to show the user which posts are not read yet. This deletes the tracking information and individual forum tracking settings.';
