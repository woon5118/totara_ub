...
class mod_facetoface_renderer extends plugin_renderer_base {
    ...
    public function print_session_list_table(array $sessions, bool $viewattendees, bool $editevents, bool $displaytimezones, array $reserveinfo = array(),
        ...
        debugging('mod_facetoface_renderer::print_session_list_table() is deprecated. Please use mod_facetoface_renderer::render_session_list_table() instead.');
    ...
    public function print_session_list(seminar $seminar, int $roomid, int $eventtime = event_time::ALL): string {
        debugging('mod_facetoface_renderer::print_session_list() is deprecated. Please use mod_facetoface\output\session_list_table instead.');
    ...
    public function render_session_list(seminar $seminar, filter_list $filters, render_session_option $option, int $userid = null): string {
        debugging('mod_facetoface_renderer::render_session_list() is deprecated. Please use mod_facetoface\output\session_list_table instead.');
        ...
        if (!$seminarevents->is_empty()) {
            ...
            foreach ($seminarevents as $seminarevent) {
                ...
                $sessiondata = seminar_event_helper::get_sessiondata($seminarevent, $signup, $option->get_sessionascendingorder());
    ...
    public static function render_unordered_list(array $listitems, string $emptytext = '', string $class = 'mod_facetoface', string $outerclass = '', string $innerclass = '', string $emptyclass = 'empty'): string {
        if ($outerclass === '' && $innerclass === '') {
            ...
            throw new coding_exception('Either one of $outerclass and $innerclass is specified.');
        }
        if (empty($listitems)) {
