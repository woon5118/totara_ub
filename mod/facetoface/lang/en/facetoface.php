...
$string['cancelsessionconfirm'] = 'Are you sure you want to cancel this event? All booking and attendance records will be removed and all attendees will be notified. This action cannot be un-done.';
...
$string['filterbyeventtime'] = 'Event time :';
$string['filterbyroom'] = 'Filter by rooms :';
...
$string['filter_event:all'] = 'All events';
$string['filter_event:inprogress'] = 'Events in progress';
$string['filter_event:over'] = 'Past events';
$string['filter_event:upcoming'] = 'Upcoming events';
$string['floor'] = 'Floor';
...
$string['sessionslist:eventstatus'] = 'Event booking';
...
$string['attendancetracking:saved'] = 'Saved';
$string['sessionattendance'] = 'Session attendance tracking';
$string['sessionattendance_help'] = 'When there are multiple sessions within one event, ticking this setting allows attendance to be tracked on a per session basis. If this remains unticked then attendance will be tracked on a per event basis.';
...
$string['eventgradingmanual_help'] = 'Manual event grading decouples event grades from attendance record. Event grades will not be calculated by the system and will need to be entered manually.';
...
$string['gradeinput_label'] = 'Event grade';
...
$string['signupregistrationclosed'] = 'The sign-up period for your selected session closed on the {$a->date}, {$a->time} {$a->timezone}.';
