...
$string['addfacilitatortositewidelist'] = 'Add to sitewide list';
$string['addfacilitatortositewidelist_help'] = 'Add this facilitator to the sitewide list to make it reusable in other seminars across the site';
...
$string['facilitatornamelink'] = 'Facilitator Name (linked to details page)';
$string['facilitators'] = 'Facilitators';
$string['facilitatorshown'] = 'Facilitator shown successfully';
$string['facilitatorsourcetitle'] = 'Seminar Facilitators';
$string['facilitatorsourcetitleassignments'] = 'Seminar Facilitators Assignments';
$string['facilitatortype'] = 'Type';
$string['facilitatortype_help'] = 'Type help';
...
$string['filter_booking:booked'] = 'My booked events';
...
$string['managefacilitators'] = 'Manage failitators';
...
$string['selectfacilitator'] = 'To view this report, first <a href="{$a}">select a facilitator</a> you want to view.';
...
$string['status_capacity_waitlisted'] = ' ({$a} Wait-listed)';
