...
$string['embedded:seminarassetsupcoming'] = 'Seminars: Upcoming sessions using asset';
...
$string['embedded:seminarroomsupcoming'] = 'Seminars: Upcoming sessions using room';
$string['embedded:seminarsessionattendance'] = 'Seminars: Session sign-in sheet';
