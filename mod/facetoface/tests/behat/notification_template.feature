...
Feature: Edit face-to-face notification templates
  In order to update face-to-face notifications across the site
  As admin
  ...
  Scenario: Check that the correct face-to-face notification templates have been installed
    ...
    When I navigate to "Notification templates" node in "Site administration > Face-to-face"
    And I click on "Edit" "link" in the "Face-to-face booking admin request" "table_row"
    ...
    When I navigate to "Notification templates" node in "Site administration > Face-to-face"
    And I click on "Edit" "link" in the "Face-to-face booking confirmation" "table_row"
    Then I should see "This is to confirm that you are now booked on the following course"
    And I should see "Room: [session:room:name]"
    And I should not see "Room: [session:room]"

  @javascript
  Scenario: Old placeholders are identified in face-to-face notification templates
    When I navigate to "Notification templates" node in "Site administration > Face-to-face"
    ...
    When I click on "Edit" "link" in the "Face-to-face booking decline" "table_row"
  ...
  @javascript
  Scenario: Updating templates can be set to update the notifications in a face-to-face activity
    ...
    When I click on "Edit" "link" in the "Face-to-face registration closed" "table_row"
    Then the following fields match these values:
      | Template | Face-to-face registration closed: [facetofacename], [starttime]-[finishtime], [sessiondate] |
      | Title    | Face-to-face registration closed: [facetofacename], [starttime]-[finishtime], [sessiondate] |
    And I should see "The registration period for the following session has been closed:"
    When I navigate to "Notification templates" node in "Site administration > Face-to-face"
    And I click on "Edit" "link" in the "Face-to-face registration closed" "table_row"
    And I set the following fields to these values:
  ...
  @javascript
  Scenario: Updating templates can be set to not update the notifications in a face-to-face activity
    When I click on "Find Learning" in the totara menu
    And I follow "Course 1"
    And I turn editing mode on
    And I add a "Face-to-face" to section "1" and I fill the form with:
