...
Feature: Check seminar room identifiers setting
  ...
  Background:
    ...
    And I click on "Room 1, Some Building 1, 123 Main Street (Capacity: 10)" "text" in the "Choose a room" "totaradialogue"
    And I click on "OK" "button" in the "Choose a room" "totaradialogue"
    And I press "Save changes"
    And I follow "Add event"
    And I click on "Select room" "link"
    And I click on "Room 2, Some Building 2 (Capacity: 10)" "text" in the "Choose a room" "totaradialogue"
    And I click on "OK" "button" in the "Choose a room" "totaradialogue"
    And I press "Save changes"
    And I follow "Add event"
    And I click on "Select room" "link"
    And I click on "Room 3, 321 Main Street (Capacity: 10)" "text" in the "Choose a room" "totaradialogue"
    And I click on "OK" "button" in the "Choose a room" "totaradialogue"
    And I press "Save changes"
