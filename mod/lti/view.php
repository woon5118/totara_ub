...
if ( $launchcontainer == LTI_LAUNCH_CONTAINER_WINDOW ) {
    ...
    echo '<iframe id="contentframe" height="600px" width="100%" src="launch.php?id='.$cm->id.'" allow=\'microphone *; camera *\' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
