...
/**
 * This item takes care of purging, exporting and counting the instant messages received by the given user.
 ...
 */
class instant_messages_received extends item {
    ...
    public static function get_fullname_string() {
        return ['userdataiteminstant_messages_received', 'message'];
    }
    ...
    protected static function export(target_user $user, \context $context) {
        ...
        $messages = $DB->get_records_sql(
            'SELECT *
                FROM {message}
                WHERE useridto = ? AND eventtype = ?
                ORDER BY useridfrom, timecreated ASC',
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        $countmessages = $DB->count_records('message', ['useridto' => $user->id, 'eventtype' => 'instantmessage']);
        $countmessagesread = $DB->count_records('message_read', ['useridto' => $user->id, 'eventtype' => 'instantmessage']);
