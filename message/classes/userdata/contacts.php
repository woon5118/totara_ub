...
/**
 * This items is responsible for exporting, deleting and purging any contacts in the messaging system.
 * It includes contacts the given user added himself.
 */
class contacts extends item {
    ...
    public static function get_fullname_string() {
        return ['userdataitemcontacts', 'message'];
    }
    ...
    protected static function export(target_user $user, \context $context) {
        ...
        // Load all contacts.
        $contacts = $DB->get_records('message_contacts', ['userid' => $user->id]);
        $export->data = array_map(function($item) { return (array)$item; }, $contacts);
