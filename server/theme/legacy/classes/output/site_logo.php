...
class site_logo implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        debugging('The class theme_legacy\output\site_logo has been deprecated since 12.0. Use totara\core\classes\output\masthead_logo.php instead.');
