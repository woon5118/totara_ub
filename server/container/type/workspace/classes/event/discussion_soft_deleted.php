 ...
 */
final class discussion_soft_deleted extends base {
    /**
     * @return string
     */
    public static function get_name() {
        return get_string('discussion_soft_deleted', 'container_workspace');
    }
     ...
     *
     * @return discussion_soft_deleted
     */
    public static function from_discussion(discussion $discussion, ?int $actor_id = null): discussion_soft_deleted {
        ...
        /** @var discussion_soft_deleted $event */
