...
$string['delete_warning_title'] = 'Are you sure?';
$string['description_label'] = 'Description (optional)';
...
$string['member_added_message'] = 'You are now member of the {$a} workspace';
...
$string['request_to_join_space'] = 'Request to join workspacespace {$a}';
$string['save'] = 'Save';
...
$string['select_new_owner'] = "Select new owner";
$string['size'] = 'Size';
...
$string['warning_change_title'] = "This will result in a change";
$string['warning_change_to_restricted'] = 'Some of this content is only visible to you. If you share it with this workspace, it will become visible for all members of the workspace.';
$string['warning_change_to_public'] = 'Some of this content is only visible to you, or limited people. If you share it with a public workspace, it will become visible for all users.';
...
$string['error:create_discussion'] = 'Cannot create a discussion for workspace {$a}';
...
$string['error:manual_enrol'] = 'Cannot manual add user to workspace {$a}';
$string['error:self_enrol'] = 'Cannot self enrol to workspace {$a}';
$string['error:update'] = 'Cannot update the workspace {$a}';
