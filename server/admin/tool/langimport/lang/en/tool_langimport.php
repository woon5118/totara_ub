...
//$string['remotelangnotavailable'] = 'Connect to download.totaralms.com, it is not possible for language packs to be installed automatically.'; // Not used in Totara.
