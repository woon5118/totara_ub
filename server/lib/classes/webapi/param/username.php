...
/**
 * Input parameter equivalent to PARAM_USERNAME.
 *
 * Clean username to only contains allowed characters.
 ...
 */
final class username extends \core\webapi\param {
    /**
    ...
    public static function parse_value($value): ?string {
        ...
        $cleaned = clean_param($value, PARAM_USERNAME);
        if ($cleaned !== $value) {
