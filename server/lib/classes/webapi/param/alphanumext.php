 ...
 * Contains only English ascii letters a-zA-Z, numbers 0-9 and characters '_' and '-'.
 *
 * NOTE: empty strings are allowed.
 */
final class alphanumext extends \core\webapi\param {
    /**
    ...
    public static function parse_value($value): ?string {
        ...
        $cleaned = clean_param($value, PARAM_ALPHANUMEXT);
        if ($cleaned !== $value) {
