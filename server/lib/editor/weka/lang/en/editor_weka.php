...
$string['display_as_embedded_media'] = 'Display as embedded media';
$string['display_as_text'] = 'Display as text';
$string['display_text'] = 'Display text';
$string['done'] = 'Done';
$string['edit_image_alt_text'] = 'Edit alt text';
$string['edit_link_label'] = 'Edit link';
