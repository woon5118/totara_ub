...
$string['coursecompat_help'] = 'This setting sets the default "course compatible in-app" value for new courses created. It defines whether individual courses can be accessed from within the Totara Mobile App.';
$string['coursecompatible'] = 'Course compatible in-app';
$string['coursecompatible_help'] = 'This setting defines whether the course can be accessed from within the Totara Mobile App.';
...
$string['app:server_not_reachable:message'] = 'The server is not reachable. Please check your network connection and try again.';
...
$string['app:content_error:title'] = 'Not available';
$string['app:content_error:description'] = 'Please check your connection and try again';
...
$string['app:course:course_criteria:bottom_sheet_header'] = 'This activity is not available unless';
...
$string['app:course:activity:not_available'] = 'Not available';
$string['app:course:course_activity_section:accessibility_image'] = 'Activity image';
$string['app:course:course_activity_section:accessibility_image_zoom'] = 'Activity image zoom';
...
$string['app:course_group:criteria:bottom_sheet_header'] = 'This course is not available unless';
