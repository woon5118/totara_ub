...
class duplicate_course extends base {

    public function __construct(int $programid, $exceptionob=null) {
        parent::__construct($programid, $exceptionob);
        $this->exceptiontype = manager::EXCEPTIONTYPE_DUPLICATE_COURSE;
    }

    public function handles(int $action): bool {
        return in_array($action, [manager::SELECTIONACTION_OVERRIDE_EXCEPTION, manager::SELECTIONACTION_DISMISS_EXCEPTION]);
    }
