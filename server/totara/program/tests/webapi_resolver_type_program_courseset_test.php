 ...
 */
class totara_program_webapi_resolver_type_program_courseset_testcase extends advanced_testcase {

    use webapi_phpunit_helper;

    private function resolve($field, $courseset, array $args = []) {
        ...
        return \totara_program\webapi\resolver\type\courseset::resolve(
            $field,
            $courseset,
            $args,
            $excontext
    ...
    public function test_resolve_courses() {
        ...
        foreach ($value as $course) {
            $this->assertInstanceOf('stdClass', $course);
