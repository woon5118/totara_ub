 ...
 */
namespace totara_reportedcontent\userdata;

use totara_userdata\userdata\item;
use totara_userdata\userdata\target_user;

final class reportedcontent extends item {
    /**
    ...
    protected static function purge(target_user $user, \context $context): int {
        ...
        $sql = "UPDATE {totara_reportedcontent} SET complainer_id = null WHERE complainer_id = :userid";
