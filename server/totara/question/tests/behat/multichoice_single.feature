...
Feature: Admin interface of single answer multichoice question
  ...
  Background:
    ...
    And I set the field "datatype" to "Multiple choice (one answer)"
  ...
  Scenario: totara_question 101: Make default link
    ...
    And I should not see "unselect" in the "#fgroup_id_choice_1" "css_element"

  Scenario: totara_question 102: Unselect link
  ...
  Scenario: totara_question 103: Add more link
  ...
  Scenario: totara_question 104: Javascript works after reload
