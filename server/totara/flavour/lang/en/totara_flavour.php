...
$string['setting_core_enableengage_resources'] = 'Resources';
$string['setting_core_enableengage_resources_desc'] = 'Engage resources allow users to create and share their own content within your organisation';
$string['setting_core_enablecontainer_workspace'] = 'Workspaces';
$string['setting_core_enablecontainer_workspace_desc'] = 'Engage workspaces allow users to create shared spaces for discussions and content sharing';
$string['setting_core_enabletotara_msteams'] = 'MS Teams';
$string['setting_core_enabletotara_msteams_desc'] = 'MS Teams allows you to integrate with Microsoft teams to share content and interact with the platform';
$string['setting_core_enableml_recommender'] = 'Machine learning recommender';
$string['setting_core_enableml_recommender_desc'] = 'The machine learning recommender provides a tool to make recommendations to users';
