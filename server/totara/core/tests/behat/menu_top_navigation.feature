...
Feature: Totara Main menu navigation
  ...
  Background:
    ...
    And I set the following Totara form fields to these values:
      | Type                     | URL             |
      | Parent item              | Learn / Extra courses   |
  ...
  Scenario Outline: Navigation menu expanding and collapsing works on top level
    ...
    And I click on "Learn" "link" in the ".totaraNav" "css_element"
    Then Totara menu item "Learn" should be expanded
    And Totara menu item "Learn" should not be highlighted
    ...
    When I click on "Learn" "link" in the ".totaraNav" "css_element"
    Then Totara menu item "Learn" should not be expanded
    And Totara menu item "Learn" should not be highlighted
    And I should see "Extra courses" in the totara menu
  ...
  Scenario: Navigation menu expanding and collapsing works on second level
    ...
    Then a new page should have loaded since I started watching
    And Totara sub menu item "Find Learning" should be highlighted
