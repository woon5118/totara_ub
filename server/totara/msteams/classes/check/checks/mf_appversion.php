...
/**
 * Check manifest_app_version.
 */
class mf_appversion implements checkable {
    /**
     * @var string
     */
    protected $result = '';
    ...
    public function get_name(): string {
        return get_string('check:mf_appversion', 'totara_msteams');
    }

    public function get_config_name(): ?string {
        return 'manifest_app_version';
    }
    ...
    public function check(): int {
        ...
        if (empty($version)) {
            $this->result = get_string('check:mf_appversion_notset', 'totara_msteams');
