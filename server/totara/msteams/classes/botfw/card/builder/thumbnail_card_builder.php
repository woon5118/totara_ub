...
use totara_msteams\botfw\card\thumbnail_card;

/**
 * A builder class for a thumbnail card.
 */
class thumbnail_card_builder {
    /** @var thumbnail_card */
    private $card;
    ...
    public function __construct() {
        $this->card = new thumbnail_card();
        $this->card->contentType = 'application/vnd.microsoft.card.thumbnail';
     ...
     */
    public function build(): thumbnail_card {
        return $this->card;
    }
     ...
     * @return self
     */
    public function add_image($url): self {
