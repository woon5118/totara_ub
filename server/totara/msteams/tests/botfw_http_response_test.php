...
class totara_msteams_botfw_response_testcase extends advanced_testcase {
    ...
    public function test_get_body_as_json_failure($body) {
        $this->expectException('totara_msteams\botfw\http\exception\bad_format_exception');
    ...
    public function test_throw_if_error_failure_auth($code) {
        $this->expectException('totara_msteams\botfw\http\exception\auth_exception');
    ...
    public function test_throw_if_error_failure_request($code) {
        $this->expectException('totara_msteams\botfw\http\exception\request_exception');
