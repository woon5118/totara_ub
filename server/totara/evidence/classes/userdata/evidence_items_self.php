 ...
 *
 * This deals only with items created by the given user.
 * evidence_items_other deals with items created by other user for the given user.
 */
class evidence_items_self extends item {
    ...
    protected static function purge(target_user $user, context $context): int {
        evidence_items::create_self($user, $context)->purge();
    ...
    protected static function export(target_user $user, context $context) {
        return evidence_items::create_self($user, $context)->export();
    }
    ...
    protected static function count(target_user $user, context $context): int {
        return evidence_items::create_self($user, $context)->count();
    }
