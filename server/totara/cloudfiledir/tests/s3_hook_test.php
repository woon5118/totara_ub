...
/**
 * Test hook integration for S3 storage.
 */
final class totara_cloudfiledir_s3_hook_testcase extends totara_cloudfiledir_hook_testcase {
    protected function prepare_store_config(array $config): array {
        ...
        $config['provider'] = 's3';
        $config['options'] = \totara_cloudfiledir_s3_provider_testcase::get_provider_options();
        $config['bucket'] = \totara_cloudfiledir_s3_provider_testcase::get_provider_bucket();
