...
global $CFG;
require_once($CFG->dirroot . '/totara/engage/rb_sources/rb_source_engagedusers.php');

/**
 * Report of engaged users
 */
final class rb_engagedusers_embedded extends rb_base_embedded {
    /**
     * @var string
     */
    ...
    public function __construct(array $data) {
        ...
        $this->url = '/totara/engage/reporting/engagedusers_report.php';
        $this->source = 'engagedusers';
        $this->shortname = 'engagedusers';
        $this->fullname = get_string('engagedusers', 'totara_engage');
    ...
    protected function define_columns() {
        return rb_source_engagedusers::get_default_columns();
    }
    ...
    protected function define_filters() {
        return \rb_source_engagedusers::get_default_filters();
    }
    ...
    public function is_capable($reportfor, $report) : bool {
        ...
        return has_capability('totara/engage:view_engagedusers_reporting', $syscontext, $reportfor);
    }
