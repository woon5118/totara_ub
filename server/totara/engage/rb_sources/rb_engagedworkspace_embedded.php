...
global $CFG;
require_once($CFG->dirroot . '/totara/engage/rb_sources/rb_source_engagedworkspace.php');

/**
 * Report of engaged workspace
 */
final class rb_engagedworkspace_embedded extends rb_base_embedded {
    /**
     * @var string
     */
    ...
    public function __construct(array $data) {
        ...
        $this->url = '/totara/engage/reporting/workspace_report.php';
        $this->source = 'engagedworkspace';
        $this->shortname = 'engagedworkspace';
        $this->fullname = get_string('engagedworkspace', 'totara_engage');
    ...
    protected function define_columns() {
        return \rb_source_engagedworkspace::get_default_columns();
    }
    ...
    protected function define_filters() {
        return \rb_source_engagedworkspace::get_default_filters();
    }
    /**
    ...
    public function is_capable($reportfor, $report) : bool {
        ...
        return has_capability('totara/engage:view_engagedworkspace_reporting', $context, $reportfor);
    }
    ...
    public static function is_report_ignored() {
        return \rb_source_engagedworkspace::is_source_ignored();
    }
}