 ...
 * @package block_totara_recommendations
 */
class micro_learning_mode implements block_mode {
    /**
     * @return bool
     */
    ...
    public function get_title(): string {
        return get_string('config:block_micro_learning', 'block_totara_recommendations');
    }
    ...
    public function get_items(int $count, int $user_id): array {
        return recommendations_repository::get_recommended_micro_learning($count, $user_id);
    }
}