...
require_once($CFG->dirroot . '/blocks/totara_featured_links/backup/moodle2/backup_totara_featured_links_stepslib.php');

class backup_totara_featured_links_block_task extends backup_block_task {
    ...
    protected function define_my_steps() {
        $this->add_step(
            new backup_totara_featured_links_block_structure_step(
                'tiles_structure',
                'tiles.xml'
            )
        );
    ...
    public function get_fileareas() {
        return ['tile_background', 'tile_backgrounds'];
    }
