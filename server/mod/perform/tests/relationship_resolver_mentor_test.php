 ...
 * @covers mentor
 */
class relationship_resolver_mentor_testcase extends perform_relationship_resolver_test {
    /**
     * @var string
     */
    const ID_NUMBER = 'perform_mentor';
    ...
    public function test_get_users_by_subject_instance_id() {
        ...
        $mentor = $this->get_resolver(self::ID_NUMBER);
        $user_ids = $mentor->get_users(['subject_instance_id' => $subject_instance->id]);
    ...
    public function test_get_users_by_subject_instance_id_and_user_id() {
        ...
        $mentor = $this->get_resolver(self::ID_NUMBER);
        $user_ids = $mentor->get_users(['subject_instance_id' => $subject_instance->id, 'user_id' => $user1->id]);
