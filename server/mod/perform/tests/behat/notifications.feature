...
Feature: Perform activity notifications
  ...
  Scenario: mod_perform_notification_001: Instance creation notification
    ...
    And I click on "Subject" tui "toggle button" in the "Participant instance creation" tui "collapsible"
  ...
  Scenario: mod_perform_notification_002: Instance creation reminder
    ...
    And I click on "Subject" tui "toggle button" in the "Participant instance creation reminder" tui "collapsible"
  ...
  Scenario: mod_perform_notification_003: Due date approaching reminder
    ...
    And I click on "Subject" tui "toggle button" in the "Due date approaching reminder" tui "collapsible"
    ...
    When I log in as "user1"
    And I open the notification popover
    Then I should not see "Si avvicina la scadenza"
  ...
  Scenario: mod_perform_notification_004: On due date reminder
    ...
    And I click on "Subject" tui "toggle button" in the "On due date reminder" tui "collapsible"
    # Explicitly check the due date setting in case someone messes up with the generator
    When I switch to "Assignments" tui tab
    Then the following fields match these values:
      | dueDateOffset[from_count] | 2     |
    ...
    When I log in as "user1"
    And I open the notification popover
    Then I should not see "Notificación de fecha de vencimiento"
  ...
  Scenario: mod_perform_notification_005: Overdue reminder
    ...
    And I click on "Subject" tui "toggle button" in the "Overdue reminder" tui "collapsible"
    ...
    When I log in as "user1"
    And I open the notification popover
    Then I should not see "Försenad påminnelse"
