...
Feature: Visibility of my responses
  ...
  Scenario Outline: Viewing responses as a non subject participant
    ...
    Examples:
      ...
      | Subject only can view anon responses            | Your anonymised responses (once all participants have submitted) are visible to: | the Employee                                       | I should see that show others responses is toggled "off" |
