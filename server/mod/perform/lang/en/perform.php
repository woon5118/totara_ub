...
$string['bulk_export_filter_changed_warning_message'] = 'The report filters have changed since the page where you requested them was generated. This could be due to changes in another browser window and will lead to incorrect results. Please go back and reapply the search and export again.';
...
$string['embedded_participant_instance_manage_participation'] = 'Participant Instance Manage Participation (Perform)';
$string['embedded_participant_section_manage_participation'] = 'Participant Section Manage Participation(Perform)';
$string['embedded_subject_instance_manage_participation'] = 'Subject Instance Manage Participation (Perform)';
...
$string['embedded_element_performance_reporting'] = 'Performance data reporting: List of elements for a single activity';
$string['embedded_perform_subject_instance'] = 'Performance Subject Instance (Perform)';
$string['embedded_response_export_performance_reporting'] = 'Performance Activity Response Export (Perform)';
...
$string['x_record_selected'] = '{$a} record selected';
$string['x_records_selected'] = '{$a} records selected';
