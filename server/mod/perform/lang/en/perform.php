...
$string['activation_criteria_elements'] = 'At least one question element added';
...
$string['activity_title_for_subject'] = '{$a->activity_name} for {$a->subject_name}';
...
$string['embedded_perform_restricted_participant_instance'] = 'Performance Restricted Participant Instance (Perform)';
$string['embedded_perform_restricted_participant_section'] = 'Performance Restricted Participant Section (Perform)';
$string['embedded_perform_restricted_subject_instance'] = 'Performance Restricted Subject Instance (Perform)';
...
$string['fixed_date_selector_from'] = 'from';
...
$string['relationship_mentor'] = 'Mentor';
$string['relationship_mentor_plural'] = 'Mentors';
$string['relationship_peer'] = 'Peer';
$string['relationship_peer_plural'] = 'Peers';
$string['relationship_reviewer'] = 'Reviewer';
$string['relationship_reviewer_plural'] = 'Reviewers';
...
$string['schedule_range_date_preamble'] = 'Assigned users will have instances created for them during the period';
$string['schedule_range_date_preamble_with_from'] = 'Assigned users will have instances created for them during the period from';
...
$string['user_activities_complete_before'] = 'Complete before {$a}.';
...
$string['userdataitemexport_other_hidden_responses'] = 'Others\' responses about the user, which are hidden from the user';
$string['userdataitemexport_other_hidden_responses_help'] = 'Responses on a user\'s performance activity that have been made by others but are hidden from the user';
$string['userdataitemexport_other_visible_responses'] = 'Others\' responses about the user, which are visible to the user';
$string['userdataitemexport_other_visible_responses_help'] = 'Only responses on a user\'s own performance activity that are visible to the user.';
$string['userdataitempurge_other_responses'] = 'Others\' responses about the user';
$string['userdataitempurge_other_responses_help'] = 'All responses made by others on a user\'s own performance activity.';
$string['userdataitempurge_user_responses'] = 'User\'s responses';
$string['userdataitempurge_user_responses_help'] = 'This includes all responses a user has provided on their own performance activity and responses a user has provided on performance activities about others.';
