...
class restricted_participant_instance_actions extends base {
    ...
    public static function display($value, $format, stdClass $row, rb_column $column, reportbuilder $report) {
        ...
        $str_close = get_string('close', 'rb_source_perform_restricted_participant_instance');
        $str_re_open = get_string('re_open', 'rb_source_perform_restricted_participant_instance');
