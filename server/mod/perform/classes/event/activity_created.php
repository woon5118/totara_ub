...
class activity_created extends base {
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = activity_entity::TABLE;
    }
    ...
    public static function get_name() {
        return get_string('event_activity_created', 'mod_perform');
    }

    public function get_description() {
        return "The user with id '$this->userid' has created a performance activity with id '{$this->objectid}'.";
    }
}