...
class activity_activated extends base {
    ...
    public static function get_name() {
        return get_string('event_activity_activated', 'mod_perform');
    }

    public function get_description() {
        return "The user with id '$this->userid' has activated the performance activity with id '{$this->objectid}'.";
    }
}
