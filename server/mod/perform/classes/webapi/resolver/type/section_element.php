...
use mod_perform\formatter\activity\section_element as section_element_formatter;
 ...
 */
class section_element implements type_resolver {
    ...
    public static function resolve(string $field, $section_element, array $args, execution_context $ec) {
        if (!$section_element instanceof section_element_model) {
            throw new \coding_exception('Expected section element model');
        }

        $format = $args['format'] ?? format::FORMAT_HTML;
        $formatter = new section_element_formatter($section_element, $ec->get_relevant_context());
