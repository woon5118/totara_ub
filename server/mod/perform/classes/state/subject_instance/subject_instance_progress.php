 ...
 * @package mod_perform
 */
abstract class subject_instance_progress extends state implements state_event {
    ...
    /**
     * Manually mark a subject instance as being complete
     */
    abstract public function manually_complete(): void;

    /**
     * Manually mark a subject instance as being not complete
     */
