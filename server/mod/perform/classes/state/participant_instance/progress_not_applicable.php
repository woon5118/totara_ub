...
/**
 * This class represents the "not applicable" progress status of a participant instance, for view-only participants.
 *
 * @package mod_perform
 */
class progress_not_applicable extends participant_instance_progress {
