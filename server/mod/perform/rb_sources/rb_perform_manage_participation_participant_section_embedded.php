...
global $CFG;
require_once($CFG->dirroot . '/mod/perform/rb_sources/rb_source_perform_manage_participation_participant_section.php');

class rb_perform_manage_participation_participant_section_embedded extends rb_base_embedded {
    ...
    public function __construct(array $data) {
        ...
        $this->source = 'perform_manage_participation_participant_section';
        $this->shortname = 'perform_manage_participation_participant_section';
        $this->fullname = get_string('embedded_perform_manage_participation_participant_section', 'mod_perform');
    ...
    protected function define_columns() {
        return rb_source_perform_manage_participation_participant_section::get_default_columns();
    }
    ...
    protected function define_filters() {
        return rb_source_perform_manage_participation_participant_section::get_default_filters();
    }
