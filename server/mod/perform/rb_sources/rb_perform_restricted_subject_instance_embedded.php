...
global $CFG;
require_once($CFG->dirroot . '/mod/perform/rb_sources/rb_source_perform_restricted_subject_instance.php');

class rb_perform_restricted_subject_instance_embedded extends rb_base_embedded {
    ...
    public function __construct(array $data) {
        ...
        $this->source = 'perform_restricted_subject_instance';
        $this->shortname = 'perform_restricted_subject_instance';
        $this->fullname = get_string('embedded_perform_restricted_subject_instance', 'mod_perform');
    ...
    protected function define_columns() {
        return \rb_source_perform_restricted_subject_instance::get_default_columns();
    }
    ...
    protected function define_filters() {
        return \rb_source_perform_restricted_subject_instance::get_default_filters();
    }
