...
$string['profilefieldduplication'] = 'The profile field \'{$a}\' had already picked';
...
$string['successupdateprofilecard'] = 'Successfully update the user profile card'; // todo ux to fix the string
